...
const surveyQuestions = {
  extraversion: [
    ...
    "I seek out social interactions during breaks.",
    "I am outgoing in unfamiliar professional settings.",
    "I enjoy brainstorming sessions with others.",
    "I feel comfortable speaking up in large groups."
  ],
  agreeableness: [
    ...
    "I feel good when contributing to group success.",
    "I am empathetic toward others' challenges.",
    "I prefer collaborative over competitive work.",
    "I forgive mistakes easily in team settings."
  ],
  conscientiousness: [
    ...
    "I prefer structured routines in daily work.",
    "I take initiative to improve processes.",
    "I pay attention to details in reports.",
    "I persist through challenges to complete tasks."
  ],
  openness: [
    ...
    "I value feedback for personal growth.",
    "I explore unconventional career paths.",
    "I am open to relocating for opportunities.",
    "I find inspiration in abstract concepts."
  ],
  emotionalStability: [
    ...
    "I control my emotions during conflicts.",
    "I avoid overreacting to minor issues.",
    "I feel confident in my abilities.",
    "I cope effectively with work-life balance demands."
  ]
};
    ...
    <div className="min-h-screen flex flex-col items-center justify-center pt-24 pb-12 px-4 bg-gray-50">
      <div className="bg-white p-8 md:p-12 rounded-2xl border border-gray-200 shadow-xl w-full max-w-4xl">
        ...
        <p className="text-gray-600 text-center mb-8">
          Please answer all 50 questions honestly to help us understand your personality traits.
        </p>
            ...
            <div key={category} className="border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-6">
                {questions.map((question, questionIndex) => {
                  const questionNumber = categoryIndex * 10 + questionIndex + 1;
                  return (
