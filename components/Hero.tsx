        ...
        <div className="container mx-auto px-8 pb-16">
          <div className="max-w-3xl " style={{ marginLeft: '-40px' }} >
            ...
            <h1 className="text-7xl md:text-8xl font-semibold text-white tracking-tight">
              Global Internship<br />Initiative
            </h1>
            
            {/* Subheading with reduced spacing */}
            <div className="mt-6 mb-8">
              <h2 className="text-2xl md:text-3xl font-medium text-gray-200 leading-snug max-w-xl">
            ...
            <div className=" z-30 flex items-center space-x-3 text-gray-400">
              ...
              <span className="font-bold text-lg text-white">GLOBAL TALENT SOLUTIONS</span>
            </div>
          </div>
        </div>
      </div>
