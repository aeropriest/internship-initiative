  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <Image
        ...
        fill
        className="object-cover object-center md:object-left-center"
        priority
        quality={100}
      />
      
      {/* Gradient overlay: darker black on left, lighter towards right */}
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/60 to-black/50 md:from-black/60 md:to-black/40 z-10"></div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 pb-8 sm:pb-12 md:pb-16">
          <div className="max-w-3xl md:ml-[-40px]">
            
            {/* Main heading with tighter line spacing */}
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-semibold text-white tracking-tight leading-tight">
              Global Internship Initiative
            </h1>
            
            {/* Subheading with reduced spacing */}
            <div className="mt-4 sm:mt-5 md:mt-6 mb-6 sm:mb-7 md:mb-8">
              <h2 className="text-base sm:text-lg md:text-2xl lg:text-3xl font-thin text-gray-200 leading-snug max-w-xl">
            ...
            <div className="z-30 flex items-center space-x-1 text-gray-400">
              ...
              <span className="font-thin text-xs sm:text-sm text-white">GLOBAL TALENT SOLUTIONS</span>
            </div>
          </div>
        </div>
      </div>
